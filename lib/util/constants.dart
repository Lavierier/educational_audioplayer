...
const String loadingConfirmationInfo =
    'При медленном интернет-соединении это может занять много времени';
const String deletionConfirmationInfo =
    'Для повторного прослушивания их придется загрузить заново или слушать онлайн (для этого нужно постоянное подключение к интернету)';
const String confirmLoadingButtonText = 'Загрузить';
